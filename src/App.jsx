...
const learningSteps = [
  ...
  },
  {
    ...
    explanation: "【正解は2】\n送信者が間違いなく本人であっても、その本人のパソコンが既にマルウェアに感染しており、本人が意図せず（または騙されて）マルウェアを拡散させられているケースが多々あります。\n\n【マルウェアとウイルスの違い】\n「マルウェア (Malware)」とは、悪意のあるソフトウェア (Malicious Software) の総称です。一般的に「ウイルス」とまとめて呼ばれることが多いですが、厳密にはウイルスはマルウェアの一種に過ぎません。\n\n■ マルウェアの主な種類\n・ウイルス：他の正常なプログラムに「寄生」して自己増殖するもの。\n・ワーム：寄生せずに「単独」でネットワークを通じて自己増殖するもの。\n・トロイの木馬：便利なソフトや写真などの「ふり」をして侵入し、裏で悪事を働くもの（自己増殖はしない）。今回の偽装ファイルもこれに該当します。\n・ランサムウェア：勝手にファイルを暗号化し、元に戻すための「身代金」を要求するもの。\n・スパイウェア：パスワードや個人情報をこっそり盗み出して外部へ送信するもの。",
    illustration: () => (
